...
from RecoLocalTracker.Configuration.RecoLocalTracker_cff import siStripZeroSuppression
siStripZeroSuppressionHLT = siStripZeroSuppression.clone(
    RawDigiProducersList =cms.VInputTag(cms.InputTag("siStripDigisHLT","VirginRaw"), cms.InputTag("siStripDigisHLT","ProcessedRaw"), cms.InputTag("siStripDigisHLT","ScopeMode")
    ))
...
SiStripClusters2ApproxClusters.inputClusters = "siStripClustersHLT"

DigiToApproxClusterRawTask = cms.Task(siStripDigisHLT,siStripZeroSuppressionHLT,siStripClustersHLT,SiStripClusters2ApproxClusters)
